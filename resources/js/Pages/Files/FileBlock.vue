<template>
    <inertia-link :href="route('files.view', upload)" class="block relative group flex flex-row bg-gray-900 hover:bg-gray-800 hover:no-underline group-hover:no-underline duration-150 ease-in-out transition-all cursor-pointer border-gray-800 overflow-hidden shadow-md hover:shadow-2xl rounded-lg">
        ...
        <div class="bg-center bg-cover bg-no-repeat w-2/12 opacity-75 group-hover:opacity-100"
             :style="{'background-image' : `url(${upload.url})`}">
